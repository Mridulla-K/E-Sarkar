var voterRecords = {
  "voter123": { "mobile": "1234567890", "Password": null,"Passport": 1234, "publicKey": null, "privateKey": null },
  "voter456": { "mobile": "9876543210", "Password": null,"Passport": 1234, "publicKey": null, "privateKey": null },
};

async function login() {
  var voterId = document.getElementById('login-user').value;
  var password = document.getElementById('login-pass').value;
  var password = document.getElementById('login-passp').value;
  if (voterRecords.hasOwnProperty(voterId) && voterRecords.hasOwnProperty(Passport) ) {
